...
import ResendVerificationEmailFormHeader from "@/components/custom/ResendVerificationEmailFormHeader";
...
const ResendVerificationEmail = () => {
  ...
  return (
    <SuspenseWrapper>
      <AuthFormContainer authFormHeader={<ResendVerificationEmailFormHeader />}>
